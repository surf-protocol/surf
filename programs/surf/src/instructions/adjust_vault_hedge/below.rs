...
#[derive(Accounts)]
pub struct AdjustVaultHedgeBelow<'info> {
    #[account(
    ...
    pub vault_whirlpool_position: Box<Account<'info, WhirlpoolPosition>>,
...
impl<'info> AdjustVaultHedgeBelow<'info> {
...
drift_withdraw_borrow_context_impl!(AdjustVaultHedgeBelow);
